...
public class CopyOfTest {
    ...
    public static Object goodCopyOf(Object a, int newLength) {
        ...
        Class componentType = cl.getComponentType();  // 获取数组类型的 class
